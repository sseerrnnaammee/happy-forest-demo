...
let script = {
  ...
  Chinese: {
    ...
    No: ["没事，我一直在这里，你可以随时再来", "endDate day1", "jump day2"],
    day2: [
      "scene hamsterhouse with fadeIn",
      "show y happy at right with fadeIn",
      ,
      "y 你来啦", //场景：篝火地
      "y 请坐",
      "show y normal2 at right",
      "y ...",
      "y 你最近还好吗",
      {
        Choice: {
    ...
    paper: [
      "show y normal1 at right",
      "y 请看......",
      "show image 千纸鹤.png left",
      "show y like at right",
      "y 噔噔！",
      "y 这是我给你做的手工折纸，千纸鹤",
      "show y normal1 at right",
      "y 当然，我没法亲手把我的手工送给你",
